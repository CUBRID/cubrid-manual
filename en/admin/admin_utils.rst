...
.. option:: --dump
    ...
    If specified together with the **\-C** option, information on indexes where overflow page reads greater than the terminal node threshold have occurred is also displayed. The related system parameters are **vacuum_ovfp_check_duration** and **vacuum_ovfp_check_threshold**. ::
