...
.. option:: --dump
    ...
    - Count: The number of times the number of overflow pages read for one record exceeds the threshold (vacuum_ovfp_check_threshold) during index vacuum operation.
