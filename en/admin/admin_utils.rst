...
.. option:: --copy-lob-path
    ...
    Sets the LOB directory location of the target database to be the same as the source database's LOB directory location. If this option is omitted, the default location will be <target_database_directory>/lob. Note that this option does not copy LOB files and cannot be used together with the -B option ::
...
*   reference count : The number of times the entry has been referenced.(unix timestamp)
...
*   SQL_ID : The SQL ID is generated by converting the original SQL statement into a 32-character hexadecimal string using the MD5 hash function. The last 13 hexadecimal digits of this hash value are used as the SQL ID.
*   sql user text : Original SQL statement string
*   sql hash text : This is the rewritten SQL text
*   sql plan text : Execution Plan
...
.. note::
    ...
    *   Additional explanation for clone count
    ...
    *   MD5 For example
        ...
        *   MD5 : e1faffb3e614e6c2fba74296962386b7
