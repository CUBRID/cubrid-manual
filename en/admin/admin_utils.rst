...
*   SQL_ID : Generated by converting the original SQL statement into a 32-character hexadecimal string using the MD5 hash function. The last 13 hexadecimal digits of this hash value are used as the SQL ID.
*   sql user text : Original SQL statement string
*   sql hash text : The rewritten SQL text
