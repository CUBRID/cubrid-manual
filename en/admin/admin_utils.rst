...
.. option:: --copy-lob-path
    ...
    This option sets the LOB directory location in the target database to be the same as the LOB directory location in the source database. If this option is omitted, the default location is **<target_database_directory>/lob**. This option does not copy LOB files and cannot be used with the **-B** option. ::
