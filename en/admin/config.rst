...
**use_stat_estimation**
    ...
    **use_stat_estimation** is a parameter to specify whether to use the estimated information in calculating statistics or not. The default is no. The estimated information generated by the heap manager during DML is related to the number of added objects. it is relatively accurate for number of total objects, NOT for number of distinct values.
