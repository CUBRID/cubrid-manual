...
| Code  |                                                  |                                                     |                                                                                   |
+=======+==================================================+=====================================================+===================================================================================+
| -900  | Cannot find Java Virtual Machine library: ?      | CUBRID cannot find the JVM library from the          | Check if the JAVA_HOME or JVM_PATH variables are set correctly.                   |
|       |                                                  | JAVA_HOME or JVM_PATH environment variables          | Refer to :ref:`cubrid-pl-environment-configuration`.                              |
+-------+--------------------------------------------------+-----------------------------------------------------+-----------------------------------------------------------------------------------+
| -901  | Cannot start Java Virtual Machine: ?             | An unexpected error occurred within the JVM library  | Try reinstalling the JRE, and if the same error occurs,                           |
...
| Code  |                                                   |                                                          |                                                                                                      |
+=======+===================================================+==========================================================+======================================================================================================+
| -902  | Java Virtual Machine is not running.              | The Procedure Language Server is not started              | Start the Procedure Language Server with the **cubrid pl start <db_name>** command.                   |
|       |                                                   |                                                          | For more details, refer to :ref:`cubrid-pl-server`.                                                  |
+-------+---------------------------------------------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------+
| -903  | Cannot connect to Java Virtual Machine: ?         | The Procedure Language Server cannot connect from CAS     | Restart the Procedure Language Server. If the restart fails,                                          |
...
+-------+---------------------------------------------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------+
| -905  | An error occurred while communicating with the    | CAS received an incorrect packet from the Procedure       |                                                                                                      |
|       | Java Virtual Machine: ?                           | Language Server                                           |                                                                                                      |
+-------+---------------------------------------------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------+
