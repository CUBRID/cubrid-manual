...
Removing the obsolete collations by executing the above cubrid_synccolldb_xdb.sql script file must be perfomed before forcing the synchronization of system collations into database.
