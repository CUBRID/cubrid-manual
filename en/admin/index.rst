...
See
`How to Use the CUBRID Management Utilities (Syntax) <#admin_admin_service_server_comma_427>`_
for details.

The following result is displayed if
**cubrid**
is entered in a prompt.
...
`http://www.cubrid.org <http://www.cubrid.org>`_

**Remark**

If you want to control the service by using
**cubrid**
utility on Windows Vista or later, it is recommended that you run the command prompt with an administrator account.

If you use
**cubrid**
utility without an administrator account, the result message is not displayed even though you can run it through the User Account Control (UAC) dialog.
