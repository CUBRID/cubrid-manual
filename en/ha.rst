...
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| [Failback] [Cancelled] No hosts are registered in ha_ping_hosts, or all registered hosts are invalid, making it impossible to determine the network partition.  | Fail-back has been cancelled due to the inability to perform a ping check because there are no hosts registered in ha_ping_hosts |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| [Failover] [Cancelled] Ping check has been failed to all hosts registered in ha_ping_hosts, indicating a network partition.                                     | Fail-over is canceled because the slave node fails the ping check and determines that there is a network partition to slave node |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
...
When the master node loses its role due to reasons such as the failure to restart cub_server or disk errors, a fail-back of the master node and a fail-over of the slave node are initiated. If a disk failure has been detected, an error message like "Disk failure has occurred: prev_eof_lsa(lsa), eof_lsa(lsa)" is logged in the server error log.
...
| Diagnosis Messages                                                                                                                                              | Description                                                                                                              |
+=================================================================================================================================================================+==========================================================================================================================+
| [Failback] [Diagnosis] The master node failed to restart the server process.                                                                                    | Fail-back has been initiated since master node failed to restart cub_server process that has been terminated abnormally  |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| [Failback] [Diagnosis] The master node has lost its role due to server process problem, such as disk failure.                                                   | Fail-back has been initiated since master node lost its role due to disk failure or similar reasons.                     |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| [Failover] [Diagnosis] The master node (master_node_name) has lost its role due to server process problem, such as disk failure.                                | Fail-over has been initiated since master node lost its role due to disk failure or similar reasons.                     |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
When there is an abnormal status that two or more nodes are in charge of master role in HA environment, we call it "split-brain". n such a scenario, all master nodes except one designated to perform the master role will fail-back to slave nodes to resolve the split-brain situation. Below is a list of fail-back messages that could be logged in split-brain scenario.
