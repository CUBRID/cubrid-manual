...
*   **ssh_port**  : Specifies the **port** number of the ssh or scp used in the script. This option also applies to **expect** run from the script. The default port number is **22**.
