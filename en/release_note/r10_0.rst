...
* fixed collation in domain of a host variable which was set to default one, disregarding the collation of actual value or collation inferred (CUBRIDSUS-14787)
