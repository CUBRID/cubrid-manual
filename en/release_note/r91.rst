...
The evaluation of an assignment expression became available when there is other column inside that expression(CUBRIDSUS-3112)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Now the evaluation of an assignment expression in the SET clause of INSERT statement became available when there is other column inside that expression(e.g. b=a+1).
...
In the above example, the previous version cannot evaluate b's value, but the fixed version can evaluate b's value as 1 since a's value is specified as 0.
