...
*   The collation of remote string columns is assumed to be a binary collation.
    Remote string columns using a non-binary collation (e.g. case/accent-insensitive)
    are not supported, as the result may vary depending on the query.
