...
To compute union, difference or intersection of collections types (
**SET**
,
**MULTISET**
, and
**LIST (SEQUENCE)**
), you can use +, -, or * operators, respectively. The following table shows a result data type by operator in case that collection type is an operand.
...
, or
**UNIQUE**
(A returned instance is a distinct value.)

•
**ALL**
(All instances are returned. Duplicates are allowed.)
