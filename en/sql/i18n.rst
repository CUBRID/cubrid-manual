...
-   There is the situation when multiple users share the same CUBRID installation and an extend is done by one of them. If that user doesn't have access
    ...
    the update wasn't made will try to do an extend on his or hers databases, he or she will not be able to do this because the checksum of the library will be 
    different from the one in his or hers databases.
...
-   Each user grants access to the folders that contain his or hers databases and also the CUBRID_DATABASES variable must have the same value.
