...
*   [*option*]
    ...
    *   **-j(or --jni)**: moves to the path for statically loading Java \*.class files or \*.jar files. This option should be used to prevent native library loading errors, when loading class included JNI (native libraries). 
