...
*   *schema_name*: Specifies the schema name of the serial(maximum: 31 bytes). If omitted, the schema name of the user is used.
...
*   *schema_name*: Specifies the schema name of the serial. If omitted, the schema name of the user is used.
