...
*   *schema_name*: Specifies the schema name(maximum: 31 bytes). If omitted, the schema name of the user is used.
...
*   *schema_name*: Specifies the schema name. If omitted, the schema name of the user is used. The schema of the table to be changed and the schema of the new table must be the same.
