...
.. note:: 이 절에서 "유효 CPU 수"는 서버 구동 시 프로세스의 CPU affinity, 온라인 CPU 상태, cgroup의 CPU quota 및 cpuset 제한을 반영하여 산정한 논리 CPU 수이며, 최소값은 1이다.

+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| 용도 구분                     | 파라미터 이름                       | 적용 구분               | 세션    | 타입     | 기본값                         | 동적 변경       |
+===============================+=====================================+=========================+=========+==========+================================+=================+
| :ref:`connection-parameters`  | cubrid_port_id                      | 클라이언트/서버         |         | int      | 1523                           |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_connection_worker               | 서버                    |         | int      | 유효 CPU 수 / 2 (최소 1)       |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | min_connection_worker               | 서버                    |         | int      | 4                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | auto_scaling_window_size            | 서버                    |         | int      | 4                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | recv_budget_per_connection          | 서버                    |         | int      | 16,384                         |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | send_budget_per_connection          | 서버                    |         | int      | 32,768                         |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tcp_keepalive                       | 클라이언트/서버         |         | bool     | yes                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tcp_keepalive_idle                  | 서버                    |         | int      | 300                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tcp_keepalive_interval              | 서버                    |         | int      | 300                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tcp_keepalive_count                 | 서버                    |         | int      | 3                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | index_scan_oid_buffer_size          | 서버                    |         | byte     | 4 *                            | DBA만 가능      |
|                               |                                     |                         |         |          | :ref:`db_page_size <dpg>`      |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_agg_hash_size                   | 서버                    |         | byte     | 2,097,152(2M)                  |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_hash_list_scan_size             | 클라이언트/서버         | O       | byte     | 8,388,608(8M)                  | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_parallel_workers                | 서버                    |         | int      | 100                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | parallelism                         | 서버                    |         | int      | 4                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_subquery_cache_size             | 서버                    |         | byte     | 2,097,152(2M)                  | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | memoize_memory_limit                | 클라이언트/서버         | O       | byte     | 2,097,152(2M)                  | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | sort_buffer_size                    | 서버                    |         | byte     | 128 *                          | DBA만 가능      |
|                               |                                     |                         |         |          | :ref:`db_page_size <dpg>`      |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | dont_reuse_heap_file                | 서버                    |         | bool     | no                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | unfill_factor                       | 서버                    |         | float    | 0.1                            | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | volume_extension_path               | 서버                    |         | string   | NULL                           | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | double_write_buffer_size            | 서버                    |         | byte     | 2,097,152(2M)                  | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | data_file_os_advise                 | 서버                    |         | int      | 0                              | DBA만 가능      |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | lock_escalation                     | 서버                    |         | int      | 100,000                        | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | checkpoint_every_size               | 서버                    |         | byte     | 100,000 *                      | DBA만 가능      |
...
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`transaction-parameters` | async_commit                        | 서버                    |         | bool     | no                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | group_concat_max_len                | 서버                    |         | byte     | 1,024                          | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | intl_check_input_string             | 클라이언트              |         | bool     | no                             |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | json_max_array_idx                  | 서버                    |         | int      | 65,536                         | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_query_per_tran                  | 서버                    |         | int      | 100                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | no_backslash_escapes                | 클라이언트/서버         | O       | bool     | yes                            | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | only_full_group_by                  | 클라이언트              | O       | bool     | no                             | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | oracle_compat_number_behavior       | 클라이언트/서버         |         | bool     | no                             |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | unicode_input_normalization         | 클라이언트              |         | bool     | no                             |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | unicode_output_normalization        | 클라이언트              |         | bool     | no                             |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | update_use_attribute_references     | 클라이언트              | O       | bool     | no                             | 가능            |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`thread-parameters`      | task_worker                         | 서버                    |         | int      | -1 (자동)                      |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | task_group                          | 서버                    |         | int      | 유효 CPU 수                    |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | hardware_affinity                   | 서버                    |         | bool     | no                             |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | thread_worker_pooling               | 서버                    |         | bool     | yes                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | thread_worker_timeout_seconds       | 서버                    |         | int      | 300                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | loaddb_worker_count                 | 서버                    |         | int      | 8                              | DBA만 가능      |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`timezone-parameters`    | server_timezone                     | 클라이언트/서버         |         | string   | OS의 타임존                    |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | timezone                            | 클라이언트/서버         | O       | string   | server_timezone의 값           | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tz_leap_second_support              | 클라이언트/서버         |         | bool     | no                             |                 |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`plan-cache-parameters`  | max_plan_cache_entries              | 클라이언트/서버         |         | int      | 1,000                          |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | max_plan_cache_clones               | 서버                    |         | int      | 1,000                          |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | xasl_cache_time_threshold_in_minutes| 클라이언트/서버         |         | int      | 360                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`ha-parameters`          | ha_mode                             | 클라이언트/서버         |         | string   | off                            |                 |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
| :ref:`other-parameters`       | access_ip_control                   | 서버                    |         | bool     | no                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | access_ip_control_file              | 서버                    |         | string   |                                | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | agg_hash_respect_order              | 클라이언트              |         | bool     | yes                            | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | auto_restart_server                 | 서버                    |         | bool     | yes                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | enable_string_compression           | 클라이언트/서버         |         | bool     | yes                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | index_scan_in_oid_order             | 클라이언트              | O       | bool     | no                             | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | index_unfill_factor                 | 서버                    |         | float    | 0.05                           | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | multi_range_optimization_limit      | 클라이언트              | O       | int      | 100                            | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | optimizer_enable_merge_join         | 클라이언트              |         | bool     | no                             | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | use_stat_estimation                 | 서버                    |         | bool     | no                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | server                              | 서버                    |         | string   |                                |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | service                             | 서버                    |         | string   |                                |                 |
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | sql_trace_slow                      | 서버                    |         | msec     | -1                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | sql_trace_execution_plan            | 서버                    |         | bool     | no                             | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | use_orderby_sort_limit              | 서버                    |         | bool     | yes                            | DBA만 가능      |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | vacuum_prefetch_log_mode            | 서버                    |         | int      | 1                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | vacuum_prefetch_log_buffer_size     | 서버                    |         | int      | 3200 *                         |                 |
|                               |                                     |                         |         |          | :ref:`log_page_size <lpg>`     |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tde_keys_file_path                  | 클라이언트/서버         |         | string   | NULL                           |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | tde_default_algorithm               | 클라이언트/서버         |         | string   | AES                            |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | recovery_progress_logging_interval  | 서버                    |         | int      | 0                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | supplemental_log                    | 클라이언트/서버         |         | int      | 0                              |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | regexp_engine                       | 클라이언트/서버         | O       | string   | re2                            | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | vacuum_ovfp_check_threshold         | 서버                    |         | int      | 1000                           |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | vacuum_ovfp_check_duration          | 서버                    |         | int      | 45000                          |                 |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | deduplicate_key_level               | 클라이언트/서버         | O       | int      | -1                             | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | print_index_detail                  | 클라이언트/서버         | O       | bool     | no                             | 가능            |
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
...
다음은 데이터베이스 서버와 관련된 파라미터로 각 파라미터의 타입과 설정 가능한 값의 범위는 다음과 같다. 이 절에서 **check_peer_alive**\ 와 **db_hosts**\ 만 동적으로 변경할 수 있다.

연결 워커는 비차단 입출력 방식으로 여러 클라이언트 연결을 처리하고, 수신한 요청을 태스크 워커에 전달한다. **max_connection_worker**\ 부터 **send_budget_per_connection**\ 까지의 다섯 파라미터는 연결 워커에 적용되며 서버를 재구동한 후 반영된다.
...
+----------------------------+----------+-------------------+---------+------------------+
| max_connection_worker      | int      | 유효 CPU 수/2     | 1       | 유효 CPU 수      |
|                            |          | (최소 1)          |         |                  |
+----------------------------+----------+-------------------+---------+------------------+
| min_connection_worker      | int      | 4                 | 1       | 유효 CPU 수      |
+----------------------------+----------+-------------------+---------+------------------+
| auto_scaling_window_size   | int      | 4                 | 1       | 유효 CPU 수      |
+----------------------------+----------+-------------------+---------+------------------+
| recv_budget_per_connection | int      | 16,384            | 0       | 1,073,741,824    |
+----------------------------+----------+-------------------+---------+------------------+
| send_budget_per_connection | int      | 32,768            | 0       | 1,073,741,824    |
+----------------------------+----------+-------------------+---------+------------------+
| tcp_keepalive              | bool     | yes               |         |                  |
+----------------------------+----------+-------------------+---------+------------------+
| tcp_keepalive_idle         | int      | 300               | 60      | 31,536,000       |
+----------------------------+----------+-------------------+---------+------------------+
| tcp_keepalive_interval     | int      | 300               | 60      | 31,536,000       |
+----------------------------+----------+-------------------+---------+------------------+
...
**max_clients**
    ...
    **max_clients**\ 는 데이터베이스 서버에 동시 연결을 허용하는 일반 클라이언트(일반적으로 브로커 응용 서버(CAS))의 최대 개수를 지정하기 위한 파라미터이다. 시스템 관리자용 연결 1개와 HA 토폴로지에 따라 예약되는 복제 로그 복사 및 반영 프로세스의 연결은 이 값에 포함되지 않는다. 이 파라미터의 기본값은 **100**\ 이다.

    CUBRID 환경에서 동시 사용자 수를 증가시키기 위해서는 질의 성능을 고려하여 **max_clients** 파라미터(**cubrid.conf**) 및 :ref:`MAX_NUM_APPL_SERVER <max-num-appl-server>` 파라미터(**cubrid_broker.conf**)를 적절한 값으로 설정해야 한다. 즉, **max_clients** 파라미터를 통해 데이터베이스 서버가 허용하는 일반 클라이언트의 동시 접속 개수를 설정하고, **MAX_NUM_APPL_SERVER** 파라미터를 통해 해당 브로커가 허용하는 동시 접속 개수를 설정한다.

    예를 들어, **cubrid_broker.conf** 파일에서 [%query_editor]의 **MAX_NUM_APPL_SERVER** 값이 50이고 [%BROKER1]의 **MAX_NUM_APPL_SERVER** 값이 50인 브로커 노드 2개가 하나의 데이터베이스 서버에 접속하고, 일반 CSQL 등 브로커 이외의 일반 클라이언트는 접속하지 않는 경우 **max_clients**\ 의 값은 다음과 같이 설정할 수 있다.

    *   (각 브로커 노드 당 최대 50개) * (브로커 노드 2개) = 100

    일반 CSQL 등 브로커 이외의 일반 클라이언트가 접속한다면 예상 최대 접속 수를 위 값에 추가한다. 시스템 관리자용 연결과 HA 복제 프로세스용 예약 연결은 **max_clients** 값에 더하지 않는다.

    특히, HA 환경에서는 failover 등으로 인해 여러 브로커 노드의 접속이 하나의 데이터베이스 서버에 집중될 수 있으므로, 같은 데이터베이스에 접속하는 모든 브로커 노드의 **MAX_NUM_APPL_SERVER** 합계에 브로커 이외 일반 클라이언트의 예상 최대 접속 수를 더한 값 이상으로 설정해야 한다.

    클라이언트의 데이터베이스 접속 여부에 관계 없이 **max_clients**\ 의 개수를 크게 설정할수록 메모리 사용량이 증가하므로 주의한다.

    .. note::
        
        Linux 시스템에서 max_clients 파라미터는 "ulimit -n" 명령과 관련이 있는데, "ulimit -n" 명령은 프로세스 하나가 사용할 수 있는 file descriptor의 최대 개수를 지정한다. file descriptor는 파일뿐 아니라 네트워크 소켓도 포함하므로, "ulimit -n"의 개수는 max_clients뿐 아니라 예약 연결, 내부 소켓 및 데이터베이스 파일 등에 필요한 file descriptor의 여유분을 포함하여 설정해야 한다.

**max_connection_worker**

    **max_connection_worker**\ 는 클라이언트 연결의 비차단 네트워크 입출력을 처리하는 연결 워커의 최대 개수를 지정한다. 기본값은 유효 CPU 수를 2로 나눈 값이며, 계산 결과가 1보다 작으면 1을 사용한다. 유효 CPU 수보다 크게 설정할 수 없으며, 이 값은 동시 접속 가능한 클라이언트 수를 변경하지 않는다.

**min_connection_worker**

    **min_connection_worker**\ 는 자동 조정되는 연결 워커 개수의 최소값을 지정한다. 기본값은 **4**\ 이며, **max_connection_worker** 값보다 크면 **max_connection_worker** 값으로 조정된다.

**auto_scaling_window_size**

    **auto_scaling_window_size**\ 는 연결 워커 개수를 자동 조정할 때 비교할 워커 개수 범위를 지정한다. 기본값은 **4**\ 이다. 연결 워커 개수를 고정하려면 **min_connection_worker** 및 **max_connection_worker** 값을 같게 설정한다.

**recv_budget_per_connection**, **send_budget_per_connection**

    **recv_budget_per_connection** 및 **send_budget_per_connection**\ 은 한 번의 입출력 처리에서 하나의 연결이 수신하거나 송신할 수 있는 최대 바이트 수를 지정한다. 기본값은 각각 **16,384**\ (16KB)와 **32,768**\ (32KB)이며, **0**\ 은 제한하지 않음을 의미한다. 이 제한은 한 연결이 연결 워커를 독점하지 않도록 한다.
...
**tcp_keepalive** 
    ...
    **tcp_keepalive**\ 는 TCP 네트워크 프로토콜에 SO_KEEPALIVE 옵션을 적용할지 여부를 지정하는 파라미터로, 기본값은 **yes**\ 이다. 이 값이 **no**\ 이면 마스터 노드와 슬레이브 노드 간 방화벽이 설정되어 있는 환경에서 장시간 동안 트랜잭션 로그가 복사되지 않을 때 DB 서버 쪽 연결이 종료되는 현상이 발생할 수 있다.
    ...
    서버의 TCP keepalive 동작은 다음 파라미터로 설정하며, 시간 단위는 초이다. 이 파라미터들은 서버를 재구동한 후 적용된다.

    *   **tcp_keepalive_idle**: 첫 번째 keepalive probe를 전송하기 전까지 연결이 유휴 상태로 유지되는 시간이다. 기본값은 **300**\ 이다.
    *   **tcp_keepalive_interval**: keepalive probe를 재전송하는 간격이다. 기본값은 **300**\ 이다.
    *   **tcp_keepalive_count**: 연결이 끊어진 것으로 판단하기 전까지 전송할 keepalive probe의 최대 횟수이다. 기본값은 **3**\ 이다.

    이 세 파라미터는 **tcp_keepalive**\ 가 **yes**\ 인 경우에만 적용된다. keepalive probe에 응답이 없는 유휴 연결을 끊어진 것으로 판단하기까지의 시간은 약 **tcp_keepalive_idle** + (**tcp_keepalive_interval** × **tcp_keepalive_count**)이며, 기본값 기준으로 약 **1,200초(20분)**\ 이다. 이 세 파라미터의 도입 이전 버전에서는 운영체제 기본값을 사용했으므로 감지 시간이 달라질 수 있다.
...
+--------------------------------+--------+---------------------------+---------------------------+---------------------------+
| parallelism                    | int    | 4                         | 0                         | MIN(32, 시스템 코어 수)   |
+--------------------------------+--------+---------------------------+---------------------------+---------------------------+
| max_subquery_cache_size        | byte   | 2,097,152(2M)             | 0                         | 16,777,216(16M)           |
+--------------------------------+--------+---------------------------+---------------------------+---------------------------+
| memoize_memory_limit           | byte   | 2,097,152(2M)             | 0                         | 없음                      |
+--------------------------------+--------+---------------------------+---------------------------+---------------------------+
...
**max_parallel_workers**
    ...
    **max_parallel_workers**\ 는 서버 전체에서 동시에 실행할 수 있는 병렬 질의 워커(parallel query worker) 스레드의 최대 개수를 설정하는 파라미터이다. 기본값은 **100**\ 이며, 최소값은 **0**, 최대값은 **1000**\ 이다.
    ...
    각 서버 스레드는 질의 실행 전에 **병렬 질의 워커 매니저(parallel query worker manager)**\ 를 통해 필요한 워커 수를 미리 예약(reserve)하며, 작업 완료되면 즉시 해제(release)한다. 가용 워커가 부족하여 요청한 수를 모두 예약하지 못하면 실제 예약된 워커 수만큼만 병렬로 실행되며, 예약된 워커가 하나도 없으면 해당 질의는 일반적인 단일 스레드 실행 방식으로 수행된다.

    이 파라미터는 cubrid.conf에 설정한 후 서버를 재시작해야 적용되며, **SET SYSTEM PARAMETERS** 문으로는 변경할 수 없다.

    병렬 질의 실행에 대한 자세한 내용은 :ref:`parallel-query`\ 를 참고한다.

    다음은 최대 200개의 병렬 워커를 허용하는 예제이다. ::
    ...
    .. note::
        ...
        병렬 질의의 각 워커 스레드는 독립적인 자원(메모리 등)을 사용하므로, 사용하는 병렬 워커 수가 늘어날수록 서버의 전체 메모리 사용량이 증가한다.
...
**parallelism**
    ...
    **parallelism**\ 은 단일 병렬 연산에 할당할 수 있는 **병렬 처리 수준(degree of parallelism)**\ 의 상한값을 설정하는 파라미터이다. 기본값은 **4**\ 이며, 최소값은 **0**, 최대값은 **MIN(32, 시스템 CPU 코어 수)**\ 이다.
    ...
    **PARALLEL(N)** 힌트가 사용되면 해당 파라미터 값을 무시하고 N 만큼의 워커를 할당 시도한다. 단 최대 허용값(32 또는 시스템 코어 수 중 작은 값)은 초과할 수 없다.
    ...
    힌트가 없는 경우, 개별 병렬 연산에 할당되는 워커의 수는 이 파라미터 값을 초과할 수 없다. 하지만 하나의 전체 질의가 여러 개의 병렬 연산을 동시에 수행하는 구조인 경우에는 해당 질의에 사용되는 총 병렬 워커수는 이 파라미터 값을 초과할 수 있다. 단, 서버 전체에서 수행되는 병렬 워커 수는  :ref:`max_parallel_workers <max_parallel_workers>` 값을 초과할 수는 없다.

    **PARALLEL** ( *degree* ) 힌트를 사용하여 질의별로 병렬 처리 수준을 재정의할 수 있다. 자세한 내용은 :ref:`parallel-query`\ 를 참고한다.

    이 파라미터는 cubrid.conf에 설정한 후 서버를 재시작해야 적용되며, **SET SYSTEM PARAMETERS** 문으로는 변경할 수 없다. 서버 기동 시에는 다음 순서로 값이 조정된다.

    *   시스템의 CPU 코어 수보다 크면 코어 수로 낮춘다.
    *   그 결과가 :ref:`max_parallel_workers <max_parallel_workers>` 값보다 크면 그 값으로 다시 낮춘다.

    다음은 기본 병렬 처리 수준을 8로 설정하는 예제이다. ::

        parallelism=8

    .. note::

        **parallelism** 파라미터는 개별 병렬 연산의 상한값을 설정하지만, 하나의 전체 질의의 실제 병렬 실행 여부와 수준은 처리량 규칙, 테이블 크기, :ref:`max_parallel_workers <max_parallel_workers>` 설정 등에 따라 결정된다.
...
**memoize_memory_limit**
    ...
    **memoize_memory_limit**\ 는 :ref:`MEMOIZE <memoize>` 최적화가 캐시 하나에 사용할 수 있는 메모리 크기를 설정하기 위한 파라미터이다. 값 뒤에 B, K, M으로 단위를 붙일 수 있으며, 각각 Bytes, Kilobytes, Megabytes를 의미한다. 단위를 생략하면 바이트 단위가 적용된다. 기본값은 **2,097,152** (2M) 바이트이며, 최소값은 **0**\ 이다.
    ...
    이 파라미터가 **0**\ 으로 설정되면 MEMOIZE 최적화가 비활성화된다. MEMOIZE 최적화에는 힌트가 없으므로 이 파라미터가 유일한 제어 수단이며, 다음과 같이 세션 단위로도 변경할 수 있다. ::

        SET SYSTEM PARAMETERS 'memoize_memory_limit=0';

    이 값은 캐시 하나에 대한 한도이다. 캐시는 MEMOIZE가 적용되는 조인마다, 병렬 실행 시에는 워커 스레드마다 별도로 할당되므로 하나의 질의가 사용하는 전체 캐시 메모리는 이 값보다 커질 수 있다.

    .. note::

        이 파라미터의 값은 질의 계획을 캐시하는 키에 포함되므로, 값을 변경하면 같은 질의라도 별도의 질의 계획이 생성된다.
...
**double_write_buffer_size**
    ...
    **double_write_buffer_size** 는 이중 쓰기 버퍼 (Double Write Buffer, DWB)의 메모리와 디스크 공간을 설정할 수 있는 파라미터이다. 이 크기를 0으로 설정함으로써 Partial I/O를 방지하기 위한 DWB를 사용하지 않을 수 있다. 기본적으로 DWB는 활성화되어 있으며, 기본값은 **2M** 이다. 해당 값은 **바이트 단위(byte)** 로 동작하므로, 최소 2,097,152 바이트에서 최대 33,554,432 바이트 사이의 값으로 설정해야 한다.
...
**log_max_archives**
    ...
    **log_max_archives** 는 보존할 보관 로그 파일의 최대 개수를 설정하는 파라미터이다. 최소값은 0이며, 기본값은 **INT_MAX** (2,147,483,647)이다. 이 파라미터의 동작 방식은 force_remove_log_archives 설정 여부에 따라 달라질 수 있다. 예를 들어, cubrid.conf 파일에서 log_max_archives = 3이고 force_remove_log_archives = yes로 설정되어 있을 경우, 가장 최근의 아카이브 로그 파일 3개만 유지된다. 즉, 네 번째 아카이브 로그 파일이 생성되면, 가장 오래된 아카이브 로그 파일이 자동으로 삭제된다. 삭제된 아카이브 로그에 대한 정보는 \*_lginf 파일에 기록된다. 사용자가 ha_mode=off, force_remove_log_archives=n 으로 설정하면, 시스템은 log_max_archives에 사용자가 입력한 값 대신, INT_MAX(2,147,483,647)값을 자동으로 할당한다.
...
스레드 파라미터 설정을 통해 요청을 실행하는 태스크 워커 풀과 연결 워커의 하드웨어 affinity를 관리할 수 있다. 새 태스크 워커 및 하드웨어 affinity 파라미터는 동적으로 변경할 수 없으며 서버를 재구동한 후 적용된다. 각 파라미터의 타입과 설정 가능한 값의 범위는 다음과 같다.

+---------------------------------------+--------+-------------------+---------+------------------+
| 파라미터 이름                         | 타입   | 기본값            | 최소값  | 최대값           |
+=======================================+========+===================+=========+==================+
| task_worker                           | int    | -1 (자동)         | 1       | 1,048,576        |
+---------------------------------------+--------+-------------------+---------+------------------+
| task_group                            | int    | 유효 CPU 수       | 1       | 유효 CPU 수      |
+---------------------------------------+--------+-------------------+---------+------------------+
| hardware_affinity                     | bool   | no                |         |                  |
+---------------------------------------+--------+-------------------+---------+------------------+
| thread_worker_pooling                 | bool   | yes               |         |                  |
+---------------------------------------+--------+-------------------+---------+------------------+
| thread_worker_timeout_seconds         | int    | 300               | -1      | 3600             |
+---------------------------------------+--------+-------------------+---------+------------------+
| loaddb_worker_count                   | int    | 8                 | 2       | 64               |
+---------------------------------------+--------+-------------------+---------+------------------+

.. warning::

    **thread_core_count** 파라미터의 이름은 **task_group**\ 으로 변경되었다. 이전 버전에서 업그레이드하는 경우 **cubrid.conf**\ 에 남아 있는 **thread_core_count** 항목을 **task_group**\ 으로 변경해야 한다. **thread_core_count**\ 는 더 이상 인식되지 않으므로 이 항목이 남아 있으면 데이터베이스 서버가 구동되지 않는다.

    **thread_connection_pooling** 및 **thread_connection_timeout_seconds** 파라미터는 설정 파일에서 인식되지만 현재 서버 동작에는 사용되지 않는다.

**task_worker**

    **task_worker**\ 는 클라이언트 요청을 실행하는 태스크 워커의 최대 개수를 지정한다. 기본값 **-1**\ 은 서버 구동 시 최대 연결 용량을 기준으로 자동 설정함을 의미한다.

**task_group**

    **task_group**\ 은 태스크 워커 풀을 나누는 그룹의 개수를 지정한다. 기본값은 프로세스 affinity와 cgroup의 CPU 제한 등을 반영한 유효 CPU 수이며, **task_worker** 값보다 크게 설정된 경우 **task_worker** 값으로 조정된다.

**hardware_affinity**

    **hardware_affinity**\ 는 연결 워커와 coordinator를 CPU에 고정하고, 주 네트워크 인터페이스의 채널, IRQ affinity 및 RPS/XPS를 해당 CPU에 맞추어 설정할지를 지정한다. 기본값은 **no**\ 이다.

    .. warning::

        이 값을 **yes**\ 로 설정하면 호스트의 네트워크 설정이 변경된다. root 권한으로 서버를 구동하거나 ``cub_server`` 실행 파일에 ``cap_net_admin,cap_dac_override`` capability를 부여해야 하며, ``irqbalance`` 비활성화를 권장한다. 권한이나 장치 설정 문제로 일부 설정에 실패하면 경고를 기록하고 서버 구동은 계속한다.

**thread_worker_pooling**

    **thread_worker_pooling** 파라미터가 **yes**\ 라면, 서버 부팅 시 클라이언트 요청을 실행하는 태스크 워커가 풀링된다.

**thread_worker_timeout_seconds**

    **thread_worker_timeout_seconds**\ 는 태스크 워커가 작업을 마친 후 새로운 작업을 기다리는 시간을 초 단위로 지정한다. 대기 시간을 초과하면 해당 워커가 종료되며, **-1**\ 로 설정하면 새로운 작업이 할당될 때까지 종료하지 않는다.
