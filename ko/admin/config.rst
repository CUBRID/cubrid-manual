...
|                               +-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
|                               | vacuum_ovfp_check_duration          | 서버                    |         | int      | 2678400                        |                 |
+-------------------------------+-------------------------------------+-------------------------+---------+----------+--------------------------------+-----------------+
 ...
 **vacuum_ovfp_check_threshold**\는 BTREE에서 하나의 키를 처리하기 위해 읽어야 하는 단말 노드의 오버플로우 페이지의 개수가 지정된 값보다 크면 관리 대상으로 정보를 수집한다. 기본값은 1000이다.
