...
.. note::
    ...
    * **CUBRID_TMP** 환경 변수가 설정된 경우 cub_javasp 프로세스 구동하는 Java VM에서 생성하는 임시 파일의 저장 경로를 지정하기 위해 **java_stored_procedure_jvm_options** 를 통해 지정된 **java.io.tmpdir** 의 값은 무시된다.
