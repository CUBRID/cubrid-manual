...
+==================================================================+==================+======================+
| * Windows 10 버전 2004 (빌드 19041) 이상 또는 Windows 11(WSL 버전)| 2G 이상          | 2G 이상(\*)          |
| * Windows 64 Bit Windows 7 이상 (Windows 버전)                   | 1G 이상          | 2G 이상(\*)          |
...
Windows의 WSL(Windows Subsystem for Linux) 환경에서 CUBRID를 설치하고 실행할 수 있는 설치 프로그램을 제공한다.
