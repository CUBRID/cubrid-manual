...
CCI, JDBC, PHP, ODBC, OLE DB, ADO.NET, Ruby, Python, Node.js 등의 인터페이스 모듈은 http://www.cubrid.org/wiki_apis. 에서 최신 정보를 확인할 수 있고 관련 파일을 내려받아 설치할 수 있다.

각 드라이버에 대한 간단한 설명은 :doc:`/api/index` 를 참고한다.
    
**CUBRID 도구 설치**

CUBRID 매니저, CUBRID 쿼리 브라우저 등의 도구는 http://www.cubrid.org/wiki_tools. 에서 최신 정보를 확인할 수 있고 관련 파일을 내려받아 설치할 수 있다.
...
JDBC, PHP, ODBC, OLE DB 등 인터페이스 모듈은 `<http://www.cubrid.org/wiki_apis>`_\ 에서 최신 정보를 확인할 수 있고 관련 파일을 내려받아 설치할 수 있다.
