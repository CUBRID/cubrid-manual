...
본 문서는 CUBRID 11.2(빌드 번호: 11.2.0.0645-8cdfd54)에 관한 정보를 포함한다.
...
*   CUBRID 11.2의 JDBC 및 CCI 드라이버는 CUBRID 11.0, 10.2, 10.1, 10.0, 9.3, 9.2, 9.1, 2008 R4.4, R4.3 또는 R4.1의 DB 서버와 호환된다.
*   드라이버 업그레이드를 권장한다.
