...
+----------------+------------------------+-----------------------------------------------------------------------------------------------------------------+
| default_value  | VARCHAR (2048)         | 기본값. 데이터 타입에 관계없이 모두 문자열로 저장된다. 기본값이 없으면                                          |
...
default_value        CHARACTER VARYING(2048)     매개변수의 기본값
...
+-----------+--------------------+--------------------------------------------------------------------------------+
| grants    | SEQUENCE OF        | {객체 종류, 사용자가 권한 받은 객체, 객체의 권한 부여자, 권한 종류}의 sequence |
|           |                    | 객제 종류: 1 이면 클래스, 5 이면 저장 함수                                     |
+-----------+--------------------+--------------------------------------------------------------------------------+
...
+-------------------+---------------+---------------------------------------------------------------------------------------------------------------+
| default_value     | VARCHAR(2048) | 기본값으로서 그 데이터 타입에 관계없이 모두 문자열로 저장. 기본값이 없으면                                    |
|                   |               | **NULL** , 기본값이 **NULL** 이면 'NULL'로 표현됨.                                                            |
|                   |               | 속성이 AUTO_INCREMENT이면 'AUTO_INCREMENT'로 표현됨.                                                          |
|                   |               | 데이터 타입이 객체 타입이면 'volume id | page id | slot id ', 컬렉션 타입이면                                 |
|                   |               | ' {element 1, element 2, ...}'로 표현됨.                                                                      |
+-------------------+---------------+---------------------------------------------------------------------------------------------------------------+
| is_partition_key  | VARCHAR (3)   | 파티션 키 칼럼이면 'YES', 그렇지 않으면 'NO'                                                                  |
+-------------------+---------------+---------------------------------------------------------------------------------------------------------------+
...
default_value        VARCHAR(2048)               매개변수의 기본값
