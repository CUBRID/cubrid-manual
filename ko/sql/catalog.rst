...
is_optional          INTEGER                     매개변수 선택적 여부
...
==================== ============================= =========================================================
        ...
        .. note::
            ...
            - **scode**: 사용자가 입력한 저장 프로시저 코드의 소스 코드가 저장되어 있다.

            - **otype**: 저장 프로시저 소스 코드로부터 컴파일한 목적 코드의 유형을 나타낸다.
            ...
            - **ocode**: 저장 프로시저 소스 코드로부터 컴파일하여 PL 실행 서버에서 실행할 수 있는 목적 코드가 저장되어 있다.
