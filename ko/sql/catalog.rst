...
+-------------------------+---------------------------+----------------------------------------------+
        ...
        .. note::
            ...
            - **flags**
                - **Bit 1**: WITH CHECK OPTION 속성을 가진 뷰인 경우 1
                - **Bit 2**: LOCAL CHECK OPTION 속성을 가진 뷰인 경우 1
...
+--------------------------+---------------------------+----------------------------------------------------------------------+
        ...
        .. note::
            ...
            - **options**
                - **Bit 0 ~ Bit 3**: 인덱스의 **deduplicate level** 을 나타낸다. 자세한 내용은 :ref:`deduplicate_overview` 을 참고한다.
                - 나머지 비트는 현재 사용하지 않는다.
...
다음 예제에서는 클래스 *db_trigger* 에 정의되어 있는 권한 정보를 검색한다.
...
+------------------------------------+---------------------+---------------------------------------------------------+
| referential_index_class_owner_name | VARCHAR(255)        | 외래 키가 참조하는 인덱스의 클래스 소유자명             |
+------------------------------------+---------------------+---------------------------------------------------------+
...
+--------------+--------------+------------------------------------------------------------------------------------+
| owner_name   | VARCHAR(255) | 권한부여 대상인 객체 소유자명                                                      |
+--------------+--------------+------------------------------------------------------------------------------------+
...
+-------------------+--------------+-----------------------------------------------------------------------------------------------------+
| owner_name        | VARCHAR(255) | 트리거 소유자명                                                                                     |
+-------------------+--------------+-----------------------------------------------------------------------------------------------------+
