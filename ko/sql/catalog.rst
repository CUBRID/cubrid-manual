...
+----------------+------------------------+-----------------------------------------------------------------------------------------------------------------+
| flags          | INTEGER                | 속성의 옵션을 나타내는 비트 플래그. 각 비트가 설정되어 있으면 해당 옵션이 지정된 것이다.                        |
|                |                        |                                                                                                                 |
|                |                        | * 1(bit 0): AUTO_INCREMENT 속성                                                                                 |
|                |                        | * 2(bit 1): INVISIBLE 칼럼                                                                                      |
|                |                        | * 4(bit 2): 파티션 키                                                                                           |
+----------------+------------------------+-----------------------------------------------------------------------------------------------------------------+
...
+------------------+---------------------+---------------------------------+------------------------+
| invalidated_time | DATETIME            | 뷰 쿼리가 무효화된 시각         |                        |
+------------------+---------------------+---------------------------------+------------------------+
...
+-------------------+---------------+---------------------------------------------------------------------------------------------------------------+
| is_invisible      | VARCHAR (3)   | INVISIBLE 칼럼이면 'YES', 그렇지 않으면 'NO'                                                                  |
+-------------------+---------------+---------------------------------------------------------------------------------------------------------------+
