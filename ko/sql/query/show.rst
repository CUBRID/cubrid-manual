...
태스크 워커 풀의 파티션별 상태를 보여준다. SA MODE일 때에 이 문은 아무 결과도 보여주지 않는다.
...
칼럼명                      타입            설명
=========================== =============== ===============================================================================
Jobq_index                  INT             태스크 워커 풀의 파티션(코어) 인덱스
Num_total_workers           INT             해당 파티션의 태스크 워커 스레드 총 개수
Num_busy_workers            INT             해당 파티션에서 작업 중인 태스크 워커 스레드의 개수
Num_connection_workers      INT             하위 호환성을 위한 칼럼으로 항상 0. 새 연결 워커 풀의 모니터링 값이 아님
=========================== =============== ===============================================================================
