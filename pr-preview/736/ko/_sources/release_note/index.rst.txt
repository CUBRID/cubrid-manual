...
| 작성 날짜   | 설명                                        |
+=============+=============================================+
| 2019년 12월 | CUBRID 10.2 릴리스 (10.2.0.8797-d56a158)    |
+-------------+---------------------------------------------+
...
CUBRID의 서버 엔진에는 GNU GPL v2 or later 가 적용되고 CUBRID 매니저 및 인터페이스(API)에는 BSD 라이선스가 적용된다. 보다 상세한 정보는 CUBRID 공식 사이트의 라이선스 가이드(https://www.cubrid.org/cubrid) 를 참고한다.
