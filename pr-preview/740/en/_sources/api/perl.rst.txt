...
*   CUBRID: To build the CUBRID Perl driver, the CCI driver is needed. You can obtain it by installing the CCI driver, which can be downloaded from https://www.cubrid.org/downloads. 
